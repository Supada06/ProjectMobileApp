...
import 'package:reun_kra_jok/screen/typePage.dart';
import 'package:reun_kra_jok/widget/itemTreeIndoor.dart';
import 'cart.dart';
import 'home.dart';
      ...
      body: SafeArea(
        child: ListView(
          children: <Widget>[
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: const Image(
                      ...
                      height: 150,
                      image: NetworkImage('image/bannerHome.png'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
            ...
            Row(
                children: const <Widget>[
             Padding(padding: const EdgeInsets.only(left: 35, top: 30),
              child: 
                  Text('In door',
                      style: TextStyle(
                          fontSize: 18,
